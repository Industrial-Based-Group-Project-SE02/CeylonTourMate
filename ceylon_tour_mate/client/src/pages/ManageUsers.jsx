        ...
        <div className="flex flex-col gap-4 justify-between md:flex-row md:items-center">
          ...
          {user?.role === 'admin' && (
            <button
              ...
              className="flex gap-2 items-center px-6 py-3 font-semibold text-white bg-orange-700 rounded-lg shadow-lg transition hover:bg-orange-500"
            >
      ...
      {showCreateModal && user?.role === 'admin' && (
        <div className="flex fixed inset-0 z-50 justify-center items-center p-4 bg-black bg-opacity-50">
          <div className="w-full max-w-2xl bg-white rounded-xl shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 z-10 px-8 py-6 bg-orange-700 bg-gradient-to-r to-orange-800">
            ...
            <form onSubmit={handleCreateUser} className="p-8 space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 font-semibold text-white bg-orange-700 rounded-lg transition hover:bg-orange-500"
                >
