...
const DriverDetails = () => {
    ...
    useEffect(() => {
        const fetchDriverData = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/api/drivers/user/${userId}`, {
        ...
        <div className="driver-profile-container">
            <style jsx>{`
                :root {
                    ...
                    --success-gradient: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%);
                    --navy-blue: #1e3a8a;
                    --navy-blue-light: #3b82f6;
                    --navy-blue-dark: #1e40af;
                    --navy-blue-lighter: #dbeafe;
                    --navy-blue-accent: #2563eb;
                    --card-shadow: 0 20px 40px rgba(30, 58, 138, 0.1), 0 5px 15px rgba(30, 58, 138, 0.05);
                ...
                .profile-badge {
                    ...
                    padding: 6px 16px;
                    border-radius: 20px;
                    background: ${isExistingDriver ? 'rgba(30, 64, 175, 0.9)' : 'rgba(37, 99, 235, 0.9)'};
                }
