...
export default function BookingForm() {
  ...
  const handleCustomizeClick = () => {
    if (!showCustomizeOptions) {
      ...
      setForm({ ...form, package: "Custom", packageCategory: "Custom", packageId: null });
    }
  ...
  const closeSuccessModal = () => {
    ...
    setTimeout(() => {
      setForm({
        ...
        packageId: dbPackages.length > 0 ? dbPackages[0].id : null,
        notes: "",
      });
  ...
  const handleBookClick = async () => {
    ...
    console.log('📝 Preparing booking with userId:', userId, 'email:', userEmail);
    ...
    try {
      ...
      formData.append('bookingDetails', JSON.stringify(bookingData));
          ...
          <div className="success-modal">
            ...
            <div className="success-modal-body">
              <p className="success-message">
                Your feedback is valuable in helping us improve our services.
              </p>
                ...
                <div className="booking-details">
                  ...
                  <div className="booking-details-grid">
                    <div className="booking-detail-item">
                      <div className="booking-detail-label">Package</div>
                      <div className="booking-detail-value">{bookingDetails.package}</div>
                    </div>
                    <div className="booking-detail-item">
                      <div className="booking-detail-label">Total Price</div>
                      <div className="booking-detail-value">{bookingDetails.price}</div>
                    </div>
                    <div className="booking-detail-item">
                      <div className="booking-detail-label">Name</div>
                      <div className="booking-detail-value">{bookingDetails.name}</div>
                    </div>
                    <div className="booking-detail-item">
                      <div className="booking-detail-label">Email</div>
                      <div className="booking-detail-value">{bookingDetails.email}</div>
                    </div>
                    <div className="booking-detail-item">
                      <div className="booking-detail-label">Arrival Date</div>
                      <div className="booking-detail-value">{bookingDetails.date} at {bookingDetails.time}</div>
                    </div>
                    <div className="booking-detail-item">
                      <div className="booking-detail-label">Duration</div>
                      <div className="booking-detail-value">{bookingDetails.days} days</div>
                    </div>
                  </div>
                  
                  <div style={{marginTop: '20px', padding: '15px', background: '#f0f9ff', borderRadius: '8px', borderLeft: '4px solid #10b981'}}>
                    <div style={{fontWeight: '600', color: '#047857', marginBottom: '8px'}}>
                      ✅ What happens next?
                    </div>
                    <ul style={{margin: '0', paddingLeft: '20px', color: '#4a5568'}}>
                      <li>A detailed itinerary will be sent to your email within 24 hours</li>
                      <li>Our team will contact you to confirm the details</li>
                      <li>You'll receive a welcome package before your arrival</li>
                      <li>24/7 customer support is available during your stay</li>
                    </ul>
                  </div>
                </div>
              )}
              ...
              <div style={{marginTop: '30px', textAlign: 'center', color: '#718096', fontSize: '14px'}}>
                <p>Need immediate assistance? 📞 +94 11 234 5678</p>
                <p style={{marginTop: '5px'}}>We look forward to welcoming you to Sri Lanka! 🌴</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  {uniqueVehicleTypes.length > 0 ? (
                    uniqueVehicleTypes.map(type => (
                      <option key={type} value={type}>
                        {type} <span className="vehicle-price-badge">${getVehiclePrice(type)}/day</span>
                      </option>
                    ))
                  ) : (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ cursor: 'pointer', flex: 1 }}>
                      ...
                      <div className="package-highlights">
                        ...
                        {pkg.inclusions?.includes('Breakfast') && <span>🍽️ Breakfast Included</span>}
                        {pkg.inclusions?.includes('Wi-Fi') && <span>📶 Free Wi-Fi</span>}
                      </div>
                    </div>
