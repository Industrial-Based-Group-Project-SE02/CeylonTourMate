      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {drivers.map((driver) => (
            <div key={driver.userId} className="overflow-hidden bg-white rounded-xl shadow-lg transition hover:shadow-xl">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex gap-4 items-center">
                    {driver.profilePicture ? (
                      ...
                      <div className="flex justify-center items-center w-16 h-16 text-xl font-bold text-purple-600 bg-white rounded-full border-4 border-white">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-100">{driver.email}</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 items-center text-sm">
                        ...
                        <span className="font-semibold text-gray-800">{driver.driverDetails.vehicleType}</span>
                      </div>
                    ...
                    <div className="flex gap-2 pt-4 border-t">
                      ...
                      <button
                        onClick={() => handleDeleteDriver(driver.userId)}
              ...
              {/* Active Status Badge */}
              {!driver.isActive && (
                <div className="px-6 py-2 text-center text-red-700 bg-red-50 border-t border-red-200">
                  Account Deactivated
                </div>
              )}
            </div>
        ...
        {drivers.length === 0 && (
          <div className="py-12 text-center bg-white rounded-xl shadow">
            ...
            <h3 className="mb-2 text-xl font-semibold text-gray-800">No Drivers Yet</h3>
