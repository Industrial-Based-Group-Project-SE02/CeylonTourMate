...
const CreatePackage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => {
                    navigate('/manager/ManagePackage');
                }, 2000);
            } else {
    ...
    const sidebarItems = [
        { icon: <Package className="w-5 h-5" />, label: 'Packages', path: '/manager/ManagePackage' },
        ...
        >
            <div className="p-4 min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 md:p-6">
                <div className="mx-auto max-w-7xl">
                    {/* Header */}
                    <div className="p-6 mb-8 bg-gradient-to-r from-orange-600 to-orange-800 rounded-2xl shadow-xl md:p-8">
                        <div className="flex flex-col gap-6 justify-between items-start md:flex-row md:items-center">
                            <div>
                                <div className="flex gap-3 items-center mb-2">
                                    <button
                                        onClick={() => navigate('/manager/ManagePackage')}
